      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground text-sm">
            Transport in the UK has a mixed VAT rate depending on the type of
            service.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800">
            ...
            <div>
              ...
              <p className="text-xs text-amber-600 dark:text-amber-500 mt-1">
                Taxis, private hire vehicles, and car hire are subject to the
          ...
          <div className="flex items-start gap-2 p-3 rounded-lg bg-muted/60 border border-border">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Default rate: 20%</strong> —
              Unless the transaction is explicitly confirmed as a public
              transport service (bus or train), the standard 20% VAT rate will
              be applied.
            </p>
          </div>
        </div>
